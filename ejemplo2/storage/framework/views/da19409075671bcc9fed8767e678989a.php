    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <p>
                    <a href="<?php echo e(route('directorios.agregar')); ?>" class="btn btn-primary">Agregar nuevo</a>
                    <a href="<?php echo e(route('directorios.buscar')); ?>" class="btn btn-success">Buscar</a>
                </p>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $directorios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $directorio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('directorios.contactos',$directorio->codigoEntrada)); ?>" class="btn btn-info">Ver</a>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('directorios.eliminar',$directorio->codigoEntrada)); ?>" class="btn btn-danger">Eliminar</a>
                                </td>
                            </tr>
...
</html><?php /**PATH C:\wamp64\www\ejemplo2\resources\views/directorio.blade.php ENDPATH**/ ?>