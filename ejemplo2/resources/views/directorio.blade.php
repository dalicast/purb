    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <p>
                    <a href="{{route('directorios.agregar')}}" class="btn btn-primary">Agregar nuevo</a>
                    <a href="{{route('directorios.buscar')}}" class="btn btn-success">Buscar</a>
                </p>
                    ...
                    <tbody>
                        @foreach($directorios as $directorio)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('directorios.contactos',$directorio->codigoEntrada)}}" class="btn btn-info">Ver</a>
                                </td>
                                <td>
